...
The eCalc online tool was used to validate our calculations, and as seen by the graph on the following page, there should be no issue reaching flight times over 8 minutes at speeds below 15 [mph].
